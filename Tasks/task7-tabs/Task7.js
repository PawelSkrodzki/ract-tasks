...
function App() {
  ...
  // Zapytać Przemocnego jak to się dzieje
  // Podejrzewamy, że pierw wykonuje się render, stąd nie czyta naszych danych
  // I musimy wjechać z czymś przed render przed ten komponent gdzie używamy tych wartości z data
  useEffect(() => {
    setCompanyData(data)
    setLoading(false)
  }, [])
